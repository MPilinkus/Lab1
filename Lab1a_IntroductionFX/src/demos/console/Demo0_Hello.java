...
//           kai duotas kampas yra nurodomas laipsniais
    void calculateSinConTan(){
        double rad = Math.toRadians(readLastInt());
        printLn("Sin = %.4f" + Math.sin(rad) + " Cos = " + Math.cos(rad) + " Tan = " + Math.tan(rad));
    }
    @Override
    public void createControls() {
        ...
        addButton("calcSinCosTan", e -> calculateSinConTan());
    }
    @Override
